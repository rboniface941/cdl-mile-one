    ...
    <Card style={{ marginBottom: 12 }} padding={16}>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ color: COLORS.slate, fontSize: 12, fontFamily: FONTS.regular, marginTop: 2 }}>
        ...
        >
          <Text style={{ color: COLORS.amber, fontSize: 11, fontFamily: FONTS.semibold, textTransform: 'uppercase' }}>
            {item.status}
          </Text>
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', gap: 16, marginBottom: 10 }}>
        <View>
          <Text style={{ color: COLORS.slate, fontSize: 11, fontFamily: FONTS.medium }}>CARRIER</Text>
          <Text style={{ color: COLORS.white, fontSize: 14, fontFamily: FONTS.regular }}>{item.carriers?.company_name}</Text>
        </View>
        <View>
          <Text style={{ color: COLORS.slate, fontSize: 11, fontFamily: FONTS.medium }}>POSITION</Text>
          <Text style={{ color: COLORS.white, fontSize: 14, fontFamily: FONTS.regular }}>{item.carriers?.job_title}</Text>
        </View>
      </View>
    ...
    <ScreenWrapper scrollable={false} padding={false}>
      <View style={{ paddingHorizontal: 20, paddingTop: 16 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <Text style={{ color: COLORS.white, fontSize: 24, fontFamily: FONTS.semibold, letterSpacing: -0.02 * 24 }}>
            Job Applications
          </Text>
          <Button
            title="Export CSV"
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={{ alignItems: 'center', paddingTop: 40 }}>
            <Text style={{ color: COLORS.slate, fontSize: 15, fontFamily: FONTS.regular }}>No applications yet</Text>
          </View>
        }
      />
    </ScreenWrapper>
